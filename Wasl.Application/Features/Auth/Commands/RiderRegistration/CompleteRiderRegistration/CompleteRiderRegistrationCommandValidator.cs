...
{
    public class CompleteRiderRegistrationCommandValidator : AbstractValidator<CompleteRiderRegistrationCommand>
    {
        private readonly IStringLocalizer<SharedResource> _localizer;
        public CompleteRiderRegistrationCommandValidator(IStringLocalizer<SharedResource> localizer)
        {
