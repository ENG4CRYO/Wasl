...
{
    public class VerifyRiderOtpCommandValidator : AbstractValidator<VerifyRiderOtpCommand>
    {
        private readonly IStringLocalizer<SharedResource> _localizer;
        public VerifyRiderOtpCommandValidator(IStringLocalizer<SharedResource> localizer)
        {
