...
{
    public class UpdateRiderProfileCommandValidator : AbstractValidator<UpdateRiderProfileCommand>
    {
        private readonly IStringLocalizer<SharedResource> _localizer;

        public UpdateRiderProfileCommandValidator(IStringLocalizer<SharedResource> localizer)
        {
