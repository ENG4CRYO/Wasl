...
{
    public class UpdateRiderProfileCommandHandler : IRequestHandler<UpdateRiderProfileCommand, ApiResponse<RiderProfileDto>>
    {
        ...
        public async Task<ApiResponse<RiderProfileDto>> Handle(UpdateRiderProfileCommand request, CancellationToken cancellationToken)
        {
            ...
            if (phoneTaken)
                return ApiResponse<RiderProfileDto>.Failure(_localizer["Profile.PhoneNumberAlreadyTaken"]);
            ...
            return ApiResponse<RiderProfileDto>.Success(dto, _localizer["Profile.UpdatedSuccessfully"]);
        }
