...
{
    public class CancelRideByRiderCommandValidator : AbstractValidator<CancelRideByRiderCommand>
    {
        private readonly IStringLocalizer<SharedResource> _localizer;
        public CancelRideByRiderCommandValidator(IStringLocalizer<SharedResource> localizer)
        {
