...
public class UpdateRiderProfileCommandHandlerTests
{
    private readonly Mock<IApplicationDbContext> _dbContextMock;
    private readonly Mock<ICurrentUserService> _currentUserServiceMock;
    private readonly Mock<IStringLocalizer<SharedResource>> _localizerMock;
    private readonly List<ApplicationUser> _users;
    private readonly UpdateRiderProfileCommandHandler _handler;
    private const string UserId = "user-1";

    public UpdateRiderProfileCommandHandlerTests()
    {
        ...
        _handler = new UpdateRiderProfileCommandHandler(
    ...
    public async Task Handle_ValidRequest_UpdatesProfileAndReturnsDto()
    {
        ...
        result.Data.Email.Should().Be("rider@wasl.com");
        result.Data.Balance.Should().Be(250m);
    ...
    public async Task Handle_Unauthenticated_ReturnsFailure()
    {
        ...
        var result = await _handler.Handle(new UpdateRiderProfileCommand(), CancellationToken.None);
